...
REAL_GROUP_STAGE_RESULTS_FILE = SETTINGS.external_dir / "real_group_stage_results.csv"
REAL_ROUND_OF_32_RESULTS_FILE = SETTINGS.external_dir / "real_round_of_32_results.csv"
REAL_ROUND_OF_16_RESULTS_FILE = SETTINGS.external_dir / "real_round_of_16_results.csv"
FIFA_OFFICIAL_STANDINGS_FILE = SETTINGS.external_dir / "fifa_official_standings.csv"
FIFA_OFFICIAL_STANDINGS_RAW_FILE = SETTINGS.external_dir / "fifa_official_standings_raw.json"
FIFA_OFFICIAL_BRACKET_FILE = SETTINGS.external_dir / "fifa_official_bracket.json"
FIFA_OFFICIAL_ROUND_OF_32_FILE = SETTINGS.external_dir / "fifa_official_round_of_32.csv"
FIFA_OFFICIAL_TEAM_STATS_CATALOG_FILE = SETTINGS.external_dir / "fifa_official_team_stats_catalog.json"
FIFA_OFFICIAL_TEAM_STATS_RAW_FILE = SETTINGS.external_dir / "fifa_official_team_stats_raw.json"
FIFA_OFFICIAL_TEAM_STATS_FILE = SETTINGS.external_dir / "fifa_official_team_stats.csv"
