"""Ingest official Round-of-32 results and recalibrate knockout predictions."""
...
def ingest_round_of_32(iterations: int = 1000) -> dict:
    """Build the official after-Round-of-32 snapshot."""

    engine = AdaptiveEngine(iterations=iterations)
    result = engine.build_snapshot_after_round_of_32(
